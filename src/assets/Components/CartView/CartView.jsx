    ...
    return (
        <div className='cartViewContainer'>
            <div className='cartTitle'>
                <h2>Carrito <RiShoppingCartLine color='black' /></h2>
            ...
            <div className='cartTotalContainer'>
                ...
                <Link to='/Checkout'><Button1><RiShoppingCartLine color='white' />   Finalizar Compra</Button1></Link>
                <Link to='/Store'><Button1>Seguir comprando</Button1></Link>
             </div>
        </div>
    );
}
